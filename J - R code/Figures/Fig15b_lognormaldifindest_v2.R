...
lognormaldicfindestfunc <- function(hier_logmodelc_adj30032021, brmmodel8log02042021){
  # Rstan 
  ...
  estimatesbrms <- coef(brmmodel8log02042021)$sub1
  ...
  inddiflogplot<- arrangeGrob(plotmodelest_m7log, plotmodelest_m7brms, nrow = 1, ncol = 2)
  ggsave("Fig15b_inddiflogplot_v2.png", inddiflogplot, width = 10, height = 4)
} 

lognormaldifindestfunc(hier_logmodelc_adj13012022, brmmodel8log13012022)
