...
# Estimate normal digit model scenario 3 (without individual differences) 
...
# Different priors for lognormal 
a <- -0.5  # mean for mu, mu is the mean of theta  
b <- 1  # variance for mu 
c <- 3  # mean for sigma 
...
# Estimate lognormal digit model scenario 3  
...
bridgesampling::bf(bs_lognormal3, bs_normal3)[1]$bf
# Estimated Bayes factor in favor of bs_normal3 over bs_lognormal3: 0.00000 

# Exponential difference log marginal likelihood 
exp(bs_lognormal3$logml - bs_normal3$logml)  # Inf 
