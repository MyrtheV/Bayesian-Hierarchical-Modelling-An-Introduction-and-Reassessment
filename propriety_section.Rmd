...
\Revision{Rather than submerging us in technical details or providing a formal justification of the Bayesian approach, we provide an intuition of Bayesian model comparison. A formal justification of Bayes factors is provided by @jeffreys1961theory, @kass1995bayes and @rouder2018teaching. The Bayes factor (BF) is a measure of how well one model predicts the data compared to another.}
