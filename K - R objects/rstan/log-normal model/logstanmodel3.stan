...
model {
  ...
  //betaii 
  target += lognormal_lpdf(y | gammai[group_inds] + side .* betai[group_inds] + dif1 .* delta1[group_inds] + dif2 .* delta2[group_inds] + dif3 .* delta3[group_inds] + dif4 .* delta4[group_inds], sqrt(sigma)); // does not work
