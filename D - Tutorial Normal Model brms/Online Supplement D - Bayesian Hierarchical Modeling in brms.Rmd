...
We have already estimated the model and saved it in the R object `brmmodel8_new03012022.rds`. In case you do not want to wait until the model has been fitted but continue immediately with the rest of this tutorial, you can load this R object that contains the model estimations.  
&nbsp; 
...
# For model comparison - sample_prior was set to "yes" 
model_fit_bf <- readRDS("R objects/brms/Truncated/BRMSmodelfit18_BF_03012022.rds")  
