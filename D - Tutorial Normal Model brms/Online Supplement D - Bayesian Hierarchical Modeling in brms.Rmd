...
We have already estimated the model and saved it in the R object `brmsmodelfit_final`. In case you do not want to wait until the model has been fitted but continue immediately with the rest of this tutorial, you can load this R object that contains the model estimations.  
&nbsp; 

\scriptsize 
```{r loadmodelfit, eval = FALSE}
model_fit <- readRDS(file = "myPath/brmsmodelfit_final.rds")  

# For model comparison - sample_prior was set to "yes" 
model_fit_bf <- readRDS("myPath/brmsmodelfit_BF_final.rds")  
...
# For model comparison - sample_prior was set to "yes" 
model_fit_bf <- readRDS("/Users/myrtheveenman/Documents/GitHub/multilevel-tutorial-paper/R objects/brms/Truncated/BRMSmodelfit18_BF_03012022.rds")  
