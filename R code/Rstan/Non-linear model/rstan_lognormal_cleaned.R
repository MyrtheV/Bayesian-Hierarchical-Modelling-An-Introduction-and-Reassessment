...
# 11 February 2021, using new priors based on priors standard deviation 
# 0.1135208765 0.0006024468
# 0.2467180855 0.0001129743
...
hier_logmodelc_adj13012022 <- stan(file = "/myPath/Bayesian-Hierarchical-Modelling-An-Introduction-and-Reassessment/R objects/rstan/non-linear model/logstanmodel3.stan", data = datareal, 
                           iter = 4000, chains = 4,
